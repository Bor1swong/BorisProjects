...
Page({
  ...
  translateText: function(item, index) {
    ...
    app.globalData.text123=item.text
  ...
  getContent: function () {
    ...
    wx.cloud.callFunction({
      name: 'index',
      data: {
        cont: app.globalData.text123
      },
      success: res => {
        console.log(res.result)
        //app.globalData.sentimentResult = res.result.Sentiment
        if (res.result.Sentiment=='negative'){
        myThis.setData({
          sentiment:'消极',
          odd: res.result.Negative,
          yangshi:"negative"
          });
        }else{
          myThis.setData({
            sentiment: '积极',
            odd: res.result.Positive,
            yangshi: "positive"
          });
        }
      },
  ...
  savedown: function () {
    ...
    db.collection('user').add({
      ...
      data: {
        content: app.globalData.text123,
